...
![preview](https://raw.githubusercontent.com/shahsagarm/navneet-singh-arora/main/thumbnail.png)
...
```bash
$ git clone https://github.com/shahsagarm/navneet-singh-arora.git
$ cd navneet-singh-arora
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/shahsagarm/navneet-singh-arora/blob/main/LICENSE).
